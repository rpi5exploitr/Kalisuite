"""
BullyWidget – UI wrapper for the `bully` WPS attack tool.
...
Command (simplified):
    bully -b <bssid> -c <channel> -i <interface> [--pin <pin>]
...
class BullyWidget(QWidget):
    ...
    def _build_ui(self):
        ...
        self.run_button = QPushButton("Start Bully", self)
    ...
    def handle_finished(self, exit_code: int):
        self._append_output(f"\nBully finished with exit code {exit_code}")
